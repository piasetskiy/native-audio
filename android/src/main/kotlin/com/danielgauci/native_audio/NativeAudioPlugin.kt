            ...
            if (flutterView == null) {
                ...
                flutterView = FlutterNativeView(service, false).apply {
                    pluginRegistrantCallback?.registerWith(pluginRegistry)
                            ?: throw IllegalStateException("No pluginRegistrantCallback has been set. Make sure you call AudioPlugin.setPluginRegistrantCallback(this) in your application's onCreate.")
                }
            }
